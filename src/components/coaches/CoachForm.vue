<template>
    <form @submit.prevent="submitForm()">
        ...
        <p v-if="!formIsValid">Please fill the all the fields and submit again! </p>
...
export default {
    ...
    methods: {
        ...
        submitForm(){ //we pass this data to the component which uses coach form (we could reach out to the store directly)
            this.validateForm();
